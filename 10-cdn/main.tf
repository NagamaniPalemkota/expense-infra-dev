resource "aws_cloudfront_distribution" "web_cdn" {
  origin {
    domain_name              =  "web-${var.environment}.${var.zone_name}"#web-dev.muvva.online
  ...
  aliases = ["web-${var.common_tags.component}.${var.zone_name}"]#web-cdn.muvva.online
...
module "records" {
  ...
  records = [
    {
      name    = "web-cdn" #web-cdn.muvva.online
      type    = "A"
